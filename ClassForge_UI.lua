...
function ClassForge:CreateOptionsPanel()
    ...
    meterPersistentToggle:SetPoint("TOPLEFT", meterLockToggle, "BOTTOMLEFT", 0, -10)
    ...
    meterPetsToggle:SetPoint("TOPLEFT", meterPersistentToggle, "BOTTOMLEFT", 0, -10)
    ...
    meterDebugToggle:SetPoint("TOPLEFT", meterPetsToggle, "BOTTOMLEFT", 0, -10)
    ...
    meterShowDpsToggle:SetPoint("TOPLEFT", meterDebugToggle, "BOTTOMLEFT", 0, -10)
