...
ClassForge.translations = {
    en = {
        ...
        presets = "Presets",
        presets_hint = "Presets fill class name, color, and description.",
        pick = "Pick",
        save = "Save",
    ...
    es = {
        ...
        presets_hint = "Los predefinidos rellenan nombre, color y descripcion.",
        pick = "Elegir",
        save = "Guardar",
    ...
    ru = {
        ...
        presets = "Пресеты",
        presets_hint = "Пресеты заполняют имя класса, цвет и описание.",
        pick = "Выбрать",
        save = "Сохранить",
